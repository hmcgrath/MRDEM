...
# Input files
mcd_pre_infile = 'filepath/Forest_height_2019_NAM.tif' #location of global forest file
csvtiles = 'filepath/gridlist.csv' #list of tiles to process - if want to do subset of master tile list
